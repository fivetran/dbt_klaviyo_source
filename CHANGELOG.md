[PR #28](https://github.com/fivetran/dbt_klaviyo_source/pull/28) includes the following updates:
...
# dbt_klaviyo_source v0.8.0

[PR #27](https://github.com/fivetran/dbt_klaviyo_source/pull/27) includes the following updates:
