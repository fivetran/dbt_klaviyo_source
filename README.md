...
- If you have questions or want to reach out for help, see the [GitHub Issue](https://github.com/fivetran/dbt_klaviyo_source/issues/new/choose) section to find the right avenue of support for you.
